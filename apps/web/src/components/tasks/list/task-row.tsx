...
const ROW_GRID = 'grid grid-cols-[1fr_120px_60px_140px_50px] items-center gap-2';
...
export function TaskRow({ task }: { task: ApiTask }) {
  return (
    <div className={`${ROW_GRID} px-4 py-3 border-b last:border-b-0 text-sm hover:bg-gray-50`}>
