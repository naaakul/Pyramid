  ...
  return (
    <Popover>
      <PopoverTrigger asChild>
        <Button variant="outline" size="icon" className="relative data-[state=open]:bg-ink-bg border-ink-border text-ink-900 hover:bg-ink-bg hover:text-none">
          <Bell size={16} />
          {count > 0 && (
      ...
      <PopoverContent align="end" className="w-72 p-2 border-ink-border shadow-ink-100">
        <div className="text-sm font-medium px-1 mb-1 text-ink-900">
        ...
        {(invites ?? []).map((invite) => (
          ...
          >
            ...
            <Button
              ...
              className="border-ink-border text-ink-900 hover:bg-ink-bg hover:text-none"
            >
